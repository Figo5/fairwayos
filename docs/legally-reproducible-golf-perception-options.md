...
Until then, preserve the existing CI workflow, human fallback, production gates, and best-effort YouTube workflow unchanged. The current verified local suite is 370 tests with optional-dependency skips.[1]
